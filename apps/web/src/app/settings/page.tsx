    ...
    <div className="flex flex-col gap-10">
      <Card id="account">
        <CardHeader>
          ...
          <CardDescription className="text-md">View and change your account details</CardDescription>
        </CardHeader>
      ...
      <Card id="profile">
        <CardHeader>
          ...
          <CardDescription className="text-md">Update your profile information</CardDescription>
        </CardHeader>
        <div className="px-6 mb-5">
          <Separator />
        </div>
        <CardContent className="space-y-4">
          ...
          />
          <ChangeResumeForm resume={userSettings.data.resume ?? undefined} />
        </CardContent>
        <CardFooter />
      </Card>
      ...
      <Card id="school">
        <CardHeader>
          ...
          <CardDescription className="text-md">Edit your existing academic information</CardDescription>
        </CardHeader>
        <div className="px-6 mb-5">
          <Separator />
        </div>
