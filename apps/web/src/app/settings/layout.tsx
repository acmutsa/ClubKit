  ...
  return (
    <>
      ...
      <main className="w-screen grid-cols-10 justify-center lg:grid lg:gap-12 lg:space-y-0 lg:px-6 lg:pt-6">
        ...
        <SettingsDropdown items={links} className="mb-4 lg:hidden sticky top-0 z-50 bg-background" />

        <section className="overflow-y-auto sm:px-3 px-1 pb-8 lg:col-span-8">
          {children}
        </section>
      </main>
      <Toaster richColors />
